...
public class Reportes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 110, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI Variable", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Fecha fin:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, 90, -1));
        ...
        getContentPane().add(jDateChooser_fecha_fin, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 140, -1));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        java.util.Date fechaInicioUtil = jDateChooser_fecha_inicio.getDate();
        java.util.Date fechaFinUtil = jDateChooser_fecha_fin.getDate();
        ...
        if (fechaInicioUtil != null && fechaFinUtil != null) {
            ...
            rep.ReporteVentasConDetalles(fechaInicio, fechaFin);
            JOptionPane.showMessageDialog(null, "Reporte de ventas con detalles creado con éxito");
        } else {
